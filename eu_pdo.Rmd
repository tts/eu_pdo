...
```{sparql output.var ="queryres_csv", endpoint = "http://publications.europa.eu/webapi/rdf/sparql", results="hide"}
...
```{python eval=FALSE, attr.source='.numberLines', include=FALSE}

...
[Registering a custom language engine](https://bookdown.org/yihui/rmarkdown-cookbook/custom-engine.html) in R Markdown is a novel concept to me. What it does is that it defines a chunk of code that you can then run via a function call from another chunk. Very handy. 
